...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    } else if([segue.destinationViewController respondsToSelector:@selector(setDelegate:)]){
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.detailTextLabel.text =[NSString stringWithFormat:@"%d book(s) in catalog.", [author.books count]];
}
...
-(void) addObjectController:(id)addObjectController didUpdate:(NSDictionary *)dictionary {
    NSManagedObjectContext *context = [self.fetchedResultsController managedObjectContext];
    [Author authorWithName:[dictionary valueForKey:@"name"] inManagedObjectContext:context];
}
